          ...
          <section key={section.id} id={section.id} className="dashboard-section">
            ...
            <div className="component-grid">
              {section.components.map((componentId) => {
                ...
                return (
                  <article key={componentId} className={`component-card component-card--${component.kind}`}>
                    <header>
                    ...
                    <footer>
                      <button type="button" className="component-action" aria-label={`Open ${component.title}`}>
